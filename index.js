...
*/
// let stringToInteger = "1999";
// stringToInteger = 1999;
...
function vowelCounter(vowelsParam) {
  const count = vowelsParam.match(/[aeiou]/gi).length;
  return count;
}

console.log(vowelCounter('HAILEY'));
